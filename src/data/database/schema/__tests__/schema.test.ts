...
describe('Database Schema', () => {
  ...
  describe('todos table', () => {
    ...
    it.each([
      'title', 'description', 'is_completed', 'priority', 'person_id', 'relation_type',
      'tags', 'estimated_minutes', 'due_date', 'is_recurring', 'recurrence',
  ...
  describe('reminders table', () => {
    ...
    it.each([
      ...
      'is_done', 'person_id', 'relation_type', 'priority', 'tags', 'snooze_until',
      'is_missed', 'missed_at', 'next_remind_at', 'remind_count', 'is_dismissed',
